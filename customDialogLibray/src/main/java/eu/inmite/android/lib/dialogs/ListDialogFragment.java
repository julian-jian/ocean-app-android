...
public class ListDialogFragment extends BaseDialogFragment {
	...
	private IListDialogListener iListDialogListener;
    @Override
	...
	public void setIListDialogListener(IListDialogListener iListDialogListener) {
		this.iListDialogListener = iListDialogListener;
	}

    private IListDialogListener getDialogListener() {
		if (iListDialogListener != null) {
			return iListDialogListener;
		}
