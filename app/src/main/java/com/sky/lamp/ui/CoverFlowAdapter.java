...
public class CoverFlowAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (mViewList.size() > 0 && position < mViewList.size()) {
            ...
            outHeightPadding = (int) (positionOffset * sHeightPadding);
            outWidthPadding = (int) (positionOffset * sWidthPadding);
            ...
            if (position < mViewList.size() - 1) {
                inWidthPadding = (int) ((1 - positionOffset) * sWidthPadding);
                inHeightPadding = (int) ((1 - positionOffset) * sHeightPadding);
