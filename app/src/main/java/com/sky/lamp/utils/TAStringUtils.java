...
public class TAStringUtils {
    ...
    /**
     * 判断手机号码是否正确
     * System.out.println(TAStringUtils.isPhoneNumberValid("15986773679"));
     * System.out.println(TAStringUtils.isPhoneNumberValid("13870475806"));
     * System.out.println(TAStringUtils.isPhoneNumberValid("8229356"));
     * System.out.println(TAStringUtils.isPhoneNumberValid("0794-8229356"));
     * 09-24 11:48:36.914  26476-26489/com.zqgame.dict I/System.out﹕ true
     * 09-24 11:48:36.914  26476-26489/com.zqgame.dict I/System.out﹕ true
     * 09-24 11:48:36.914  26476-26489/com.zqgame.dict I/System.out﹕ false
     * 09-24 11:48:36.924  26476-26489/com.zqgame.dict I/System.out﹕ false
     *
     * @param phoneNumber
     * @return
     */
    ...
    public static String isValidateEmail(String emailStr) {
        ...
        } else if (!Pattern.compile("\\w[\\w.-]*@[\\w.]+\\.\\w+").matcher(emailStr).matches()) {
    ...
    public static String isValidatePwd(EditText view) {
        String toastStr = isValidatePwd(view, 6, 20);
        return toastStr;
    }

    public static String isValidatePwd(EditText view, int minLength, int maxLenth) {
        String toastStr = null;
        String pwdString = view.getText().toString();
        if (isBlank(pwdString)) {
            toastStr = "请输入密码";
        } else if (pwdString.length() < minLength || pwdString.length() > maxLenth) {
            toastStr = "密码长度必须介于" + minLength + "~" + maxLenth + "位";
    ...
    public static String isValidateUname(EditText view) {
        ...
        if (isBlank(unameString)) {
            toastStr = "请输入用户名";
        } else if (unameString.length() < 1 || unameString.length() > 12) {
            toastStr = "用户名长度必须介于1~12个字符";
    ...
    public static String getTime(String planUse) {
        ...
        if (str.length == 2) {
            if (Integer.valueOf(str[0]) == 0) {
                return Integer.valueOf(str[1]) + "分钟";
            } else if (Integer.valueOf(str[1]) == 0) {
                return Integer.valueOf(str[0]) + "小时整";
            } else {
                return Integer.valueOf(str[0]) + "小时" + Integer.valueOf(str[1] + "分钟");
            }
        } else {
            return planUse + "时";
        }
