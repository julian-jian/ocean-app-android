...
public class TabHost {
    ...
    public void addTabs(TabBaseAdapter tabBaseAdapter, int textSize, int textColor, int selectedTextColor, int drawablePadding, int iconWidth, int iconHeight) {
        int count = tabBaseAdapter.getCount();
        int hasMsgIndex= tabBaseAdapter.hasMsgIndex();
        String[] textArray = tabBaseAdapter.getTextArray();
        int[] iconImageArray = tabBaseAdapter.getIconImageArray();
        int[] selectedIconImageArray = tabBaseAdapter.getSelectedIconImageArray();
