...
//        return (x < mGutterSize && dx > 0) || (x > getHeight() - mGutterSize && dx < 0);
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                if (xDiff > mTouchSlop && xDiff * 0.5f > yDiff) {
                    ...
                    if(getParent() instanceof com.emoiluj.doubleviewpager.HorizontalViewPager){
                        com.emoiluj.doubleviewpager.HorizontalViewPager parent = (com.emoiluj.doubleviewpager.HorizontalViewPager) getParent();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        //TODO ONTOUCHEVENT
        if (DEBUG) Log.i(TAG, "action "+ev.getAction() );
        if (mFakeDragging) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!mIsBeingDragged) {
                    ...
                    if (xDiff > mTouchSlop && xDiff > yDiff) {
                        ...
                        if(getParent() instanceof com.emoiluj.doubleviewpager.HorizontalViewPager){
                            com.emoiluj.doubleviewpager.HorizontalViewPager parent = (HorizontalViewPager) getParent();
                            parent.setmActivePointerId(mActivePointerId);
                            ev.setLocation(y, x);
                            parent.onTouchEvent(ev);
                            break;
